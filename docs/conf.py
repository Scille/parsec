...
project = "Parsec"
copyright = "2016-2020, Scille SAS"
...
# "default.css".
html_static_path = ["_static/parsec_theme.css"]

html_css_files = ["parsec_theme.css"]
...
man_pages = [("index", "parsec", "Parsec Documentation", ["Scille SAS"], 1)]
